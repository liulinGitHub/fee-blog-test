  ...
  <el-header>
    <div data-v-34fceecc="" class="container">
      ...
      <ul data-v-34fceecc="" class="nav-other">
        ...
        <li data-v-34fceecc="" class="nav-item-release">
          <a data-v-34fceecc="" href="#/zh-CN/resource" class="">发表文章</a>
        </li>
        <li data-v-34fceecc="" class="nav-item-auth">
          <a data-v-34fceecc="" href="#/zh-CN/resource" class="">注册</a>
        </li>
        <li data-v-34fceecc="" class="nav-item-auth">
          <a data-v-34fceecc="" href="#/zh-CN/resource" class="">登陆</a>
        </li>
      </ul>
    </div>
  </el-header>
...
<style scoped>
  ...
  .nav-item-auth[data-v-34fceecc],.nav-item-release[data-v-34fceecc] {
    margin: 0;
    float: right;
    list-style: none;
    position: relative;
  ...
  .nav-item-auth a[data-v-34fceecc],.nav-item-release a[data-v-34fceecc] {
    text-decoration: none;
    color: #1989fa;
    opacity: .5;
    display: block;
