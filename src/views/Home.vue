      ...
      <el-header data-v-34fceecc class="header">
        <div data-v-34fceecc class="container">
          ...
          <ul data-v-34fceecc="" class="nav">
              ...
              <div data-v-34fceecc="" aria-haspopup="listbox" role="combobox" aria-owns="el-autocomplete-1" class="el-autocomplete">
                ...
                <div role="region" class="el-autocomplete-suggestion el-popper algolia-search" style="display: none;">
                  <div class="el-scrollbar">
                    ...
                    <div class="el-scrollbar__bar is-vertical"><div class="el-scrollbar__thumb" style="transform: translateY(0%);">
            ...
            <li data-v-34fceecc="" class="nav-item">
              <a data-v-34fceecc="" href="#/zh-CN/guide" class="">指南</a>
            </li>
            <li data-v-34fceecc="" class="nav-item">
              <a data-v-34fceecc="" href="#/zh-CN/component" class="active">组件</a>
            </li>
            <li data-v-34fceecc="" class="nav-item nav-item-theme">
              <a data-v-34fceecc="" href="#/zh-CN/theme" class="">主题</a>
            </li>
            <li data-v-34fceecc="" class="nav-item">
              <a data-v-34fceecc="" href="#/zh-CN/resource" class="">资源</a>
            </li>
            <li data-v-34fceecc="" class="nav-item" style="">
              <div data-v-34fceecc="" class="nav-gap">
          ...
          <div class="el-scrollbar__wrap" style="margin-bottom: -17px; margin-right: -17px;">
            <div class="el-scrollbar__view" style="position: relative;">
              <div class="side-nav is-fade" style="opacity: 0.5;">
                <ul>
                  <li class="nav-item">
                    <a href="#/zh-CN/component/changelog" class="">更新日志</a>
                  </li>
                  <li class="nav-item">
                    <a href="https://eleme.github.io/element-react/" target="_blank">Element React</a>
                  </li>
...
<style>
  ...
  .headerWrapper[data-v-34fceecc] {
    height: 80px;
  }
  .header[data-v-34fceecc] {
  ...
  .header .container[data-v-34fceecc] {
    height: 100%;
  ...
  .header .nav-item[data-v-34fceecc] {
    margin: 0;
    float: left;
    list-style: none;
    position: relative;
  ...
  .header .nav-item a[data-v-34fceecc] {
